...
func (s *Server) Run() error {
	...
	mux.Handle("/api/v1/device/create-signature-device", http.HandlerFunc(s.CreateSignatureDevice))
	mux.Handle("/api/v1/device/sign-transaction", http.HandlerFunc(s.SignTransaction))
